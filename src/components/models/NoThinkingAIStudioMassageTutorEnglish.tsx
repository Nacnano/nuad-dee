...
import { massageTherapistPromptEnglish } from "@/lib/system-prompts";
...
const NoThinkingAIStudioMassageTutorEnglish: React.FC = () => {
  ...
  const startSession = useCallback(async () => {
    ...
    try {
      ...
      sessionPromiseRef.current = ai.live.connect({
        ...
        config: {
          systemInstruction: massageTherapistPromptEnglish,
...
export default NoThinkingAIStudioMassageTutorEnglish;
