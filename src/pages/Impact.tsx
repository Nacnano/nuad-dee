...
const Impact = () => {
  ...
  const testimonials = [
    {
      ...
      quote: 'This program changed my life completely. I went from unemployment to running my own successful practice.',
    ...
    },
    {
      ...
      quote: 'Our workplace wellness program has dramatically improved employee satisfaction and reduced sick days.',
    ...
    },
    {
      ...
      quote: 'The adaptive training methods made learning possible for me. I now help train other visually impaired therapists.',
  ...
  const partnerships = [
    ...
    { name: 'City Health Department', type: 'Community Programs', employees: 800 },
        ...
        <section className="mb-16">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Working with leading organizations to create inclusive employment opportunities 
              and expand access to quality massage therapy services.
            </p>
          </div>
            ...
            <Card className="border-0 shadow-medium bg-gradient-soft">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-6">
                  To create a world where visual impairment is not a barrier to meaningful employment, 
                  where skilled massage therapists can thrive professionally while providing exceptional 
                  healing services to their communities.
                </p>
        ...
        <Card className="border-0 shadow-medium bg-gradient-hero text-white">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-xl mb-6 opacity-90 max-w-2xl mx-auto">
              Whether you're looking to start your career, hire skilled therapists, 
              or support our mission, there's a place for you in our community.
            </p>
