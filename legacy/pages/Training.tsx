    ...
    const mockCourses: Course[] = [
      {
        ...
        description: 'Complete introduction to massage therapy fundamentals, anatomy, and basic techniques.',
        duration: '12 weeks',
        level: 'Beginner',
        modules: 3,
      ...
      },
      {
        ...
        description: 'Advanced techniques for therapeutic deep tissue massage and injury treatment.',
        duration: '8 weeks',
        level: 'Intermediate',
        modules: 2,
      ...
      },
      {
        ...
        description: 'Specialized methods and adaptations for visually impaired massage therapists.',
        duration: '6 weeks',
        level: 'Intermediate',
        modules: 2,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Comprehensive massage therapy education designed specifically for visually impaired learners, 
            with adaptive techniques and personalized support.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
              Our specialized training programs combine traditional massage therapy education 
              with adaptive learning techniques, ensuring every student can excel in their career.
            </p>
            ...
            <Button className="btn-hero text-lg px-6 py-3">
              Apply Now
            </Button>
          </div>
                  ...
                  <CardContent>
                    ...
                    <div className="space-y-2 mb-4 text-sm">
                      <div className="flex items-center">
                        ...
                        <span>{course.lessons.filter(l => l.type === 'theory').length} Theory Lessons</span>
                      </div>
                      <div className="flex items-center">
                        <Eye className="h-4 w-4 mr-2 text-healing" />
                        <span>{course.lessons.filter(l => l.type === 'practice').length} Practical Exercises</span>
                      </div>
                    </div>
        ...
        <Card className="border-0 shadow-medium bg-gradient-hero text-white">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-xl mb-6 opacity-90 max-w-2xl mx-auto">
              Join hundreds of graduates who have transformed their lives through 
