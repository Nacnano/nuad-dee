  ...
  const testimonials = [
    {
      name: 'Sarah Chen',
      role: 'Regular Client',
      content: 'The quality of massage therapy is exceptional. The therapists are so skilled and professional.',
      rating: 5,
      avatar: '👩‍💼'
    },
    {
      ...
      content: 'We provide workplace wellness sessions for our employees. Outstanding service every time.',
      rating: 5,
      avatar: '👨‍💼'
    },
    {
      ...
      content: 'The training program transformed my life. I found meaningful work and gained independence.',
      rating: 5,
      avatar: '👩‍⚕️'
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto text-center z-10">
          <div className="animate-fade-in-up">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
              Experience exceptional therapeutic massage while supporting meaningful employment 
              and social inclusion in our community.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              >
                <Link to="/training">Join Our Training</Link>
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <Card key={index} className="text-center card-hover animate-on-scroll border-0 shadow-soft">
            ...
            {[
              {
                ...
                description: 'Deep tissue and relaxation massage for pain relief and stress reduction',
                icon: '💆‍♀️',
                price: 'From $80'
              },
              {
              ...
              <Card key={index} className="card-hover animate-on-scroll border-0 shadow-medium">
                <CardContent className="p-8">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-lg font-semibold text-gradient-healing">{service.price}</span>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-on-scroll">
              ...
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                We provide comprehensive massage therapy training specifically designed for 
                visually impaired individuals, combining traditional techniques with adaptive learning methods.
              </p>
